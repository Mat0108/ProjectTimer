...
const Groups = () => {
    ...
    return (<>       
        ...
        <div className='relative'>
            <h1 className='text-3xl text-center mt-8 font-bold mb-20'>LIST OF GROUPS</h1>
                        ...
                        <tbody className="divide-y divide-gray-100" >
                            {groups && groups.map((item, index) => 
                                <tr key={`group-${index}`} className="bg-white mb-2">
                                    ...
                                    <td className='px-4 py-2 text-center w-[250px]'>
            ...
            <div>
                {getButtonBorder("absolute top-12 ml-10 hover:bg-white hover:text-green hover:border-green font-bold", "green", "Create a group", () => { 
                    modalChange(<CreateGroup />);
